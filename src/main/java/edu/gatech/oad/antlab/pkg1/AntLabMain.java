 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Ellie");
		  toPrint += p1.toString("emorton8");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Gautami");
		  toPrint += p2.toString("gchennur3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Nathan Schwerdfeger");
		  toPrint += p3.toString("nschwerdfeger3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Maya Holikatti");
                  toPrint += p4.toString("mholikatti3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Jeremy Schonfeld");
                  toPrint += p5.toString("jschonfeld3");
